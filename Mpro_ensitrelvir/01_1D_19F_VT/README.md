...
## Analysis Scripts
1. **01_process_bruker_to_ascii.py** Converts raw Bruker NMR data into standardized frequency/intensity ASCII files.
...
6. **07_high_res_validation_298K.py** Validation script using hard-coded "paper-quality" parameters to verify the model against high-resolution, long-collection data.
