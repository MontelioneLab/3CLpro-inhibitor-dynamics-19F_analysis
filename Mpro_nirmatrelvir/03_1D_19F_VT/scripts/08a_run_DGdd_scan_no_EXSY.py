#!/usr/bin/env python3
# ============================================================
# 08a_run_control_grid_scan_no_exsy.py
# Dual-field DG‡ profile scan control engine (EXSY completely removed)
# ============================================================
...
for DG_FIXED in DG_scan:
    ...
    def objective(x):
        ...
        # CONTROL CRITERIA: EXSY multi-temperature restraints completely removed.
    ...
    print(f"[EXSY-Free Control] DG‡ = {DG_FIXED:.2f} | RSS = {RSS:.2f} | k298 = {k298:.1f} s^-1")

# ============================================================
# 6. EXPORT CONTROL SUMMARY LOGS
# ============================================================
# FIXED: Saved to explicit control sub-files to secure isolation
outfile_pkl = os.path.join(OUTPUT_DIR, "08a_DGscan_results_noEXSY.pkl")
