...
# TARGET_SIZE updated to SIZE as confirmed by your file header
TARGET_SIZE = 16283 
LEFT_PPM  = -70.0
RIGHT_PPM = -74.0
SFO1_MHZ = 564.5881492  # 600 MHz system (Mohawk)
...
if not os.path.exists(RAW_FILE):
    ...
    # Create the frequency axis based on the SIZE points
